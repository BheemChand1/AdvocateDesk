...
<head>
<meta charset="UTF-8">
<title>Print - Completed Fees</title>
...
<table>
    ...
    <tbody>
        <?php 
        $total_fees = 0;
        foreach ($completed_accounts as $account): 
        ...
        <tr>
            ...
            <td><?php echo htmlspecialchars($account['fee_name'] ?? 'N/A'); ?></td>
            ...
            <td><?php echo htmlspecialchars($account['completed_date'] ?? 'N/A'); ?></td>
        </tr>
        <?php endforeach; ?>
    </tbody>
</table>
...
<div class="summary">
    <p><strong>Total Records:</strong> <?php echo count($completed_accounts); ?></p>
    <p><strong>Total Fee Amount:</strong> ₹<?php echo number_format($total_fees, 2); ?></p>
</div>

<?php else: ?>
<div style="text-align: center; padding: 40px; color: #666;">
    <p style="font-size: 16px;">No completed fees found.</p>
</div>
<?php endif; ?>
