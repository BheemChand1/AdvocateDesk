                    ...
                    <div class="p-6">
                        ...
                        <div class="mb-6 flex gap-3 items-center flex-wrap">
                            <form method="GET" class="w-full flex gap-3 items-center">
                                ...
                                <button 
                                    type="submit" 
                                    class="px-6 py-2 bg-green-500 text-white rounded-lg font-medium hover:bg-green-600 transition whitespace-nowrap"
                                >
                                    <i class="fas fa-search mr-2"></i>Search
                                </button>
                                <?php if (!empty($search_query)): ?>
                                <a 
                                    href="completed-fees.php" 
                        ...
                        <div class="mb-6 flex gap-3 flex-wrap">
                            <a 
                                href="export-completed-fees.php<?php echo !empty($search_query) ? '?search=' . urlencode($search_query) : ''; ?>" 
