...
// Fetch EP/Arbitration case specific details
...
<head>
    ...
    <title>EP/Arbitration Case Details - Case Management</title>
    ...
    <div class="main-content" id="mainContent">
        ...
        <main class="px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
                ...
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div>
                        <h1 class="text-3xl font-bold text-gray-800 mb-2">
                            <i class="fas fa-gavel text-purple-500 mr-3"></i>EP/Arbitration Case Details
                        </h1>
                        <p class="text-gray-600">Complete information about the EP/Arbitration case</p>
                    </div>
            ...
            <div class="bg-white rounded-xl shadow-md p-6 sm:p-8 mb-6">
                <div class="mb-6 pb-4 border-b border-gray-200">
                    <h2 class="text-2xl font-bold text-gray-800">
                        <i class="fas fa-file-alt text-blue-500 mr-2"></i>Filing Information
                    </h2>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div class="flex items-start">
                        ...
                        <div>
                            ...
                            <p class="text-lg font-bold text-gray-800"><?php echo $case_details['date_of_filing'] ? date('d M Y', strtotime($case_details['date_of_filing'])) : '-'; ?></p>
                        </div>
                    </div>
            ...
            <!-- Award & Arbitration Information -->
            <?php if ($case_details): ?>
            <div class="bg-white rounded-xl shadow-md p-6 sm:p-8 mb-6">
                <div class="mb-6 pb-4 border-b border-gray-200">
                    <h2 class="text-2xl font-bold text-gray-800">
                        <i class="fas fa-gavel text-green-500 mr-2"></i>Award & Arbitration Information
                    </h2>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div class="flex items-start">
                        ...
                        <div>
                            ...
                            <p class="text-lg font-bold text-gray-800"><?php echo $case_details['award_date'] ? date('d M Y', strtotime($case_details['award_date'])) : '-'; ?></p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start">
                        ...
                        <div>
                            ...
                            <p class="text-lg font-bold text-green-600">₹<?php echo $case_details['award_amount'] ? number_format($case_details['award_amount']) : '-'; ?></p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start">
                        ...
                        <div>
                            ...
                            <p class="text-lg font-bold text-orange-600">₹<?php echo $case_details['claim_amount'] ? number_format($case_details['claim_amount']) : '-'; ?></p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start">
                        ...
                        <div>
                            ...
                            <p class="text-lg font-bold text-teal-600">₹<?php echo $case_details['recovery_amount'] ? number_format($case_details['recovery_amount']) : '-'; ?></p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start">
                        ...
                        <div>
                            <p class="text-sm text-gray-500 mb-1">Arbitrator Name</p>
                    ...
                    <div class="flex items-start">
                        ...
                        <div>
                            <p class="text-sm text-gray-500 mb-1">Interest Amount</p>
                            <p class="text-lg font-bold text-indigo-600">₹<?php echo $case_details['interest_amount'] ? number_format($case_details['interest_amount']) : '-'; ?></p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start">
                        <div class="w-12 h-12 bg-cyan-100 rounded-lg flex items-center justify-center mr-4 flex-shrink-0">
                            <i class="fas fa-calendar-days text-cyan-600 text-lg"></i>
                        </div>
                        <div>
                            <p class="text-sm text-gray-500 mb-1">Total Days</p>
                            <p class="text-lg font-bold text-gray-800"><?php echo htmlspecialchars($case_details['total_days'] ?? '-'); ?></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-6 pt-6 border-t border-gray-200">
                    <h3 class="text-lg font-bold text-gray-800 mb-4">Interest Period</h3>
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                <p class="text-sm text-gray-500 mb-1">Interest Start Date</p>
                                <p class="text-lg font-bold text-gray-800"><?php echo $case_details['interest_start_date'] ? date('d M Y', strtotime($case_details['interest_start_date'])) : '-'; ?></p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                <p class="text-sm text-gray-500 mb-1">Interest End Date</p>
                                <p class="text-lg font-bold text-gray-800"><?php echo $case_details['interest_end_date'] ? date('d M Y', strtotime($case_details['interest_end_date'])) : '-'; ?></p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-lg font-bold text-purple-600">₹<?php echo $case_details['cost'] ? number_format($case_details['cost']) : '-'; ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <!-- Asset Details -->
                <div class="mt-6 pt-6 border-t border-gray-200">
                    <h3 class="text-lg font-bold text-gray-800 mb-4">Asset Details</h3>
                    <div class="space-y-4">
                        <?php if (!empty($case_details['vehicle_1_classification'])): ?>
                        <div>
                            <p class="text-sm text-gray-500 mb-1">Vehicle 1 Classification</p>
                            <p class="text-base text-gray-800"><?php echo htmlspecialchars($case_details['vehicle_1_classification']); ?></p>
                        </div>
                        <?php endif; ?>

                        <?php if (!empty($case_details['vehicle_2_asset_description'])): ?>
                        <div>
                            <p class="text-sm text-gray-500 mb-1">Vehicle 2 / Asset Description</p>
                            <p class="text-base text-gray-800"><?php echo htmlspecialchars($case_details['vehicle_2_asset_description']); ?></p>
                        </div>
                        <?php endif; ?>

                        <?php if (!empty($case_details['vehicle_3_registration_number'])): ?>
                        <div>
                            <p class="text-sm text-gray-500 mb-1">Vehicle 3 / Registration Number</p>
                            <p class="text-base text-gray-800"><?php echo htmlspecialchars($case_details['vehicle_3_registration_number']); ?></p>
                        </div>
                        <?php endif; ?>

                        <?php if (!empty($case_details['vehicle_4_engine_no'])): ?>
                        <div>
                            <p class="text-sm text-gray-500 mb-1">Vehicle 4 / Engine No.</p>
                            <p class="text-base text-gray-800"><?php echo htmlspecialchars($case_details['vehicle_4_engine_no']); ?></p>
                        </div>
                        <?php endif; ?>

                        <?php if (!empty($case_details['vehicle_5_chasis_no'])): ?>
                        <div>
                            <p class="text-sm text-gray-500 mb-1">Vehicle 5 / Chassis No.</p>
                            <p class="text-base text-gray-800"><?php echo htmlspecialchars($case_details['vehicle_5_chasis_no']); ?></p>
                        </div>
                        <?php endif; ?>

                        <?php if (!empty($case_details['immoveable_property_detail_1'])): ?>
                        <div>
                            <p class="text-sm text-gray-500 mb-1">Immoveable Property Detail 1</p>
                            <p class="text-base text-gray-800"><?php echo nl2br(htmlspecialchars($case_details['immoveable_property_detail_1'])); ?></p>
                        </div>
                        <?php endif; ?>

                        <?php if (!empty($case_details['immoveable_property_detail_2'])): ?>
                        <div>
                            <p class="text-sm text-gray-500 mb-1">Immoveable Property Detail 2</p>
                            <p class="text-base text-gray-800"><?php echo nl2br(htmlspecialchars($case_details['immoveable_property_detail_2'])); ?></p>
                        </div>
                        <?php endif; ?>

                        <?php if (!empty($case_details['immoveable_property_detail_3'])): ?>
                        <div>
                            <p class="text-sm text-gray-500 mb-1">Immoveable Property Detail 3</p>
                            <p class="text-base text-gray-800"><?php echo nl2br(htmlspecialchars($case_details['immoveable_property_detail_3'])); ?></p>
                        </div>
                        <?php endif; ?>
                    </div>
                </div>
